...
## Let's go some examples on how to use the MinirhozotronR package.
...
Here, we are interested in 3 key features: Root Coverage, RootScapes Features, and Peat Characteristics. Lets get to the vegan meat of it:
