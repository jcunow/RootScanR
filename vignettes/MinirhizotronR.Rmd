...
#img.skel  = raster::brick(paste0(getwd(),"/demo_images/horizontal lines.png"))
...
DepthMap = MinirhizotronR::create.depthmap(img.segm, mask = mask,start.soil = s0$soil0, center.offset = center.offset )
...
bm = MinirhizotronR::binning(DepthMap, nn = 5, "rounding")
...
buff.im = Halo(root.seg, width = 20, halo.only = FALSE)
