...
```{r document setting, include=FALSE}
...
# Directory
seg.path = "C:/Users/Documents/RootScans/SegmentedImages/"
rgb.path = "C:/Users/Documents/RootScans/RGBImages/"
cal.path = "C:/Users/Documents/RootScans/Calibration/"
...
s0 = read.csv(paste0(cal.path ,"TubeInsertionAngle.csv"))
...
for (i in im.ls) {
  ...
  ## prep root skeleton
  im.skeleton =  skeletonize(im,itr=3)
